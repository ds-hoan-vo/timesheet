                    ...
                    <tbody>
                        @for ($i = 1; $i <= now()->month($monthYear)->daysInMonth; $i++)
                            ...
                            @if (count($sheets) == 0)
                                ...
                                <td class="plan"></td>
                                <td><a type="button" class="btn btn-link create_task" data-toggle="modal"
                                        data-target="#create-task"><i class="fa fa-plus-circle"></i></a></td>
                            @endif
                            @foreach ($sheets as $item)
                                @if (date('Y-m-d', strtotime($i . '-' . $monthYear)) == $item->date)
                                    ...
                                    <td><a type="button" class="btn btn-link edit_task" data-toggle="modal"
                                            data-target="#edit_task{{ $item->id }}"><i class="fa fa-edit"></i></a></td>
                                @break
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body ">
                        <form action="{{ url('sheettask/' . $item->id) }}" method="post">
                            ...
                            <span>Difficultie</span>
                            <input type="text" class="form-control mb-2" placeholder="difficutltie"
                                name="difficult" value="{{ $item->difficult }}">
                            <span>Plan</span>
                            <input type="text" class="form-control mb-2" placeholder="plan" name="plan"
                                value="{{ $item->plan }}">
                            <span>Status</span>
                                    ...
                                    <div class="card shadow mb-2">
                                        <div class="card-body">
                                            <div class="row">
                                                ...
                                                <div class="col-auto">
                                                    <button type="button"
                                                        class="btn btn-danger delete">remove</button>
                                                </div>
